...
@pytest.mark.asyncio
async def test_temperature_only_native_change_emits_common_thermal_event(
    bambu_identity,
    bambu_idle_state,
...
@pytest.mark.asyncio
async def test_fleet_read_model_exposes_common_thermal_capability_without_bambu_wire_names(
    bambu_identity,
    bambu_idle_state,
    fake_bambu_transport,
) -> None:
