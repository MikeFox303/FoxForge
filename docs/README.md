...
- [Bambu LAN production transport](design/bambu-lan-transport.md) — Phase 7 MQTT/TLS plus implicit-FTPS transport, sticky Bambu-native state, double busy guards, verified upload semantics, indeterminate start handling, and the X2D/N6 hardware-validation boundary.
